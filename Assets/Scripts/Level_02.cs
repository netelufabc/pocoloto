...
{
    public int CharLimitForThisLevel = 4;
    public int NumeroDeSilabasDaPalavra = 2;
    private string NextLevel = "07_nivel03";
    private string PreviousLevel = "05_nivel01";
    private string SoundsDirectory = "Sounds/Level_02";
    ...
    IEnumerator CheckScore(float seconds)
    {
    ...
    IEnumerator SetScore(float seconds)
    {
        yield return new WaitForSeconds(seconds);
