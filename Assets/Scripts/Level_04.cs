...
{
    private int CharLimitForThisLevel = 8;//total de caracteres das silabas deste nivel juntas
    private int NumeroDeSilabasDaPalavra = 4;
    private string NextLevel = "09_nivel05";
    private string PreviousLevel = "07_nivel03";
    private string SoundsDirectory = "Sounds/Level_04";
    ...
    void Update()
    {
        ...
        if (!LevelController.DicaVisualAtiva)
        {
            ...
            TelaSilabaDigitada[3].text = LevelController.silabasDigitadas[3];
        }
